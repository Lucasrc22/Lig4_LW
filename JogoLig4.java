...
public class JogoLig4 {
    public static void main(String[] args) {
        try {
            ...
            jogarPartida(jogo, scanner, ranking);

            System.out.println("Top 10 Maiores Vencedores:");
            
            List<Jogador> top10Vencedores = ranking.getTop10Vencedores();
            for (int i = 0; i < top10Vencedores.size(); i++) {
                System.out.println((i + 1) + ". " + top10Vencedores.get(i).getNome());
            }
    ...
    public static void jogarPartida(Lig4 jogo, Scanner scanner, Ranking ranking) {
